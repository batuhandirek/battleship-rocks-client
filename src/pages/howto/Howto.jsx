...
export function Howto() {
    ...
    return (
        <box width="100%" height="100%">
            ...
            <button ref={button} top="80%" left="center" width={15} height={1} onPress={onBack} keys={true}>
                <box align="center" style={{ bold: true, bg: 'green', fg: 'white' }} content={`Go back`} bold></box>
            </button>
        </box>
    );
}
