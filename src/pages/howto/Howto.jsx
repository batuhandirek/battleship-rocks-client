...
export function Howto(props) {
    ...
    const LINES = [
        ...
        { text: `Battleship is a turn based game where the goal is to try and sink opponent's ships before they sink your ships.`, type: 'text' },
        { text: ``, type: 'text' },
        ...
        { text: 'After a match is found, both players are required to submit their fleet formation.', type: 'bullet' },
        { text: 'When formations are submitted, a random player is selected to make the first move.', type: 'bullet' },
        { text: 'Successful hits result in another shot given to the same player.', type: 'bullet' },
        { text: 'The turn changes to the other player when a shot is missed.', type: 'bullet' },
