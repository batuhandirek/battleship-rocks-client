...
import { changeCoordOnBoard, generateEmptyBoard, randomizeBoard, getShipAtCoordinate } from '../../lib/util';
...
export function gameReducer(state = gameInitialState, action) {
    ...
    switch (action.type) {
        ...
        case gameActionTypes.SET_GAME_SIZE: {
            ...
            const { isGamePrivate } = state;
            const stage = isGamePrivate ? MODES.CREATING : MODES.MATCHING;
            return {
                ...state,
                gameSize,
                stage,
        ...
        case gameActionTypes.OPPONENT_MOVE: {
            ...
            const newBoard = changeCoordOnBoard(state.myBoardStatus, destroyedShip, row, col, shot);
